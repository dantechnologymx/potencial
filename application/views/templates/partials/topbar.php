        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="#" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo base_url(); ?>assets/img/logo-airwatch.png" alt="" height="14">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo base_url(); ?>assets/img/logo-airwatch.png" alt="" height="30" width="100"> <span class="logo-txt"></span>
                    </span>
                </a>

                <a href="#" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo base_url(); ?>assets/img/logo-airwatch.png" alt="" height="20">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo base_url(); ?>assets/img/logo-airwatch.png" alt="" height="60"> <span class="logo-txt"></span>
                    </span>
                </a>
            </div>
                    ...
                    <form class="p-3">
                        <div class="form-group m-0">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="<?= ('Files.Search') ?>..." aria-label="Search Result">
                        ...
                        <a href="#!" class="text-reset notification-item">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="font-size-13 text-muted">
                                        <p class="mb-1"><?= ('Files.If_several_uages_coalesce_the_grammar') ?></p>
 ...
 -->
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-soft-light border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="d-none d-xl-inline-block ms-1 fw-medium"><?php echo $this->session->userdata() !== null? $this->session->userdata('nombre'):'Pruebas Conahcyt'; ?></span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                   ...
                   <a class="dropdown-item" href="auth-lock-screen"><i class="mdi mdi-lock font-size-16 align-middle me-1"></i> <?= ('Lock screen') ?></a> -->
                    ...
                    <a class="dropdown-item" href="<?php echo base_url(); ?>"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i> <?= ('Logout') ?></a>
                </div>
            </div>
